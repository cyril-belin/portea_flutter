                  ...
                  children: [
                      ...
                      children: [
                        Expanded(
                          child: ChoiceChip(
                            ...
                            onSelected: (selected) {
                              if (selected) setState(() => _type = 'vaccine');
                            },
                          ),
                        ),
                        ...
                        Expanded(
                          child: ChoiceChip(
                            ...
                            onSelected: (selected) {
                              if (selected) setState(() => _type = 'deworming');
                            },
                          ),
                        ),
                        const SizedBox(width: 8),
                          ...
                          children: [
                            ...
                            if (_setReminder) ...[
                              ...
                              Row(
                                ...
                                children: [
                                  Text('Délai :', style: AppTextStyles.body),
                                  DropdownButton<int>(
                                    value: _reminderDays,
                                    items: const [
                                      DropdownMenuItem(
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        hintText: 'Ex: Bien toléré, pris pendant le repas...',
                      ),
                    ),
                        ...
                        if (_formKey.currentState!.validate()) {
                          ...
                          if (success && mounted) {
                            ...
                            messenger.showSnackBar(
                              const SnackBar(content: Text('Soin enregistré')),
                            );
                          }
                        }
                      },
